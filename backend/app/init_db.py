...
def create_initial_products(db: Session):
    ...
    products = [
        ...
        {
            "name": "Yoga Mat",
            "description": "Non-slip yoga mat with alignment lines for proper positioning during your practice.",
            "price": 29.99,
            "image_url": "/images/products/yogamat.jpg",
            "stock": 60,
            "is_featured": False,
            "categories": [clothing],
            "variants": [
                {"name": "Thickness", "value": "4mm", "stock": 30},
                {"name": "Thickness", "value": "6mm", "stock": 30},
                {"name": "Color", "value": "Blue", "stock": 20},
                {"name": "Color", "value": "Purple", "stock": 20},
                {"name": "Color", "value": "Black", "stock": 20},
            ],
        },
        {
            "name": "Smart Watch",
            "description": "Track your fitness, sleep, and notifications with this sleek and functional smart watch.",
            "price": 149.99,
            ...
            "variants": [
                {"name": "Color", "value": "Black", "stock": 20},
                {"name": "Color", "value": "Silver", "stock": 20},
            ],
        },
        {
            "name": "Scented Candle Set",
            "description": "Set of 3 scented candles with relaxing fragrances to create a calming environment.",
            "price": 24.99,
            "image_url": "/images/products/candles.jpg",
            "stock": 80,
            "is_featured": False,
            "categories": [home, beauty],
            "variants": [
